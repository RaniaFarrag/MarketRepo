    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">Add New Date</h3>
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="#" class="kt-subheader__breadcrumbs-link">
                       Calendar                        </a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="#" class="kt-subheader__breadcrumbs-link">Add New Date</a>
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Add New Date </h3>
                        </div>
                                ...
                                <div class="col-xl-8">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <h3 class="kt-section__title kt-section__title-lg">Patients Info:</h3>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" value="+966 45678967456" placeholder="Phone" aria-describedby="basic-addon1">
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" value="amr@gmail.com" placeholder="Email" aria-describedby="basic-addon1">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="kt-section">
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input class="form-control" type="text" value="Omar Bin Abdul Aziz Road, Al-Zahra, Riyadh">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-3 col-form-label">Address Line 2</label>
                                                <div class="col-9">
                                                    <input class="form-control" type="text" value="Al-Zahra 559-488-4020">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                    ...
                                    <div class="kt-section">
                                        <div class="kt-section__body">
                                            <h3 class="kt-section__title kt-section__title-lg">Staff:</h3>
                                            <div class="form-group row">
                                                <label class="col-3 col-form-label">Staff name</label>
                                                <div class="col-9">
                                                    <input class="form-control" type="text" value="Mohamed Abdel Tawab Rashwan">
                                                </div>
                                            </div>
                                            <div class="kt-section">
                                                <div class="kt-section__body">
                                                    <div class="form-group row">
                                                        <label class="col-3 col-form-label">Staff types</label>
                                                        <div class="col-9" >
                                                            <select class="form-control">

                                                                <option value="SA" selected>Doctors</option>
                                                                <option value="SA" >Physiotherapy</option>
                                                                <option value="SA" >Nurses</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend"><span class="input-group-text"><i class="la la-at"></i></span></div>
                                                        <input type="text" class="form-control" value="M.Abdel@Sanedni.com" placeholder="Email" aria-describedby="basic-addon1">
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <select class="form-control">
                                                        ...
                                                        <option data-offset="10800" value="Riyadh" selected>(GMT+03:00) Riyadh</option>
