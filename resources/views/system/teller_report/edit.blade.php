                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <h2 class="text-white font-weight-bold my-2 mr-5">
                            {{ trans('dashboard.Edit Teller Report') }}
                        </h2>
                        <!--end::Title-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom">
                            ...
                            <form method="post" action="{{ route('update_teller_report' , $teller_report->id) }}" class="form">
                                @csrf
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select id="representative_id" name="representative_id" class="form-control select2" required>
                                                ...
                                                @foreach($representatives as $representative)
                                                    <option {{ $representative->id == $teller_report->representative_id ? 'selected' : '' }} value="{{ $representative->id }}">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select id="companies" name="company_id" class="form-control select2" required>
                                                ...
                                                @foreach($companies as $company)
                                                    <option value="{{ $company->id }}" {{ $company->id == $teller_report->company_id ? 'selected' : '' }}>
                                                        {{ $company->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group input-group-solid date"
                                                ...
                                                <input value="{{ $teller_report->date_call }}" name="date_call" type="date"
                                                       arr-name="item"
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group timepicker">
                                                ...
                                                <input value="{{ $teller_report->time_call }}" name="time_call"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                           ...
                                           <textarea class="form-control" rows="5" name="feedback">{{ $teller_report->feedback }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group input-group-solid date"
                                                 data-target-input="nearest">
                                                <input value="{{ $teller_report->date_meeting }}" name="date_meeting" type="date"
                                                       arr-name="item"
                                                       class="form-control form-control-solid "
                                                       placeholder="Select date"/>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group timepicker">
                                                {{--<input value="{{ $teller_report->time }}" name="time" arr-name="item" class="form-control" id="kt_timepicker_2" readonly placeholder="Select time" type="text"/>--}}
                                                <input value="{{ $teller_report->time_meeting }}" name="time_meeting"
                                                       arr-name="item" class="form-control"
                                                       placeholder="Select time" type="time"/>
                                            </div>
                                        </div>
