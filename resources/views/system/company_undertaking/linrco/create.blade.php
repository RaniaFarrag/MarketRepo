            ...
            <div class=" container  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        {{ trans('dashboard.Add New Undertaking For ') }} {{ $company->name }}
                        </h2>
                        <!--end::Title-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom">
                            <form method="post" action="{{ route('CompanyUndertaking.store') }}" class="form"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input value="{{ old('linrco_representative') }}" name="linrco_representative" type="text"
                                                   class="form-control" placeholder="{{ trans('dashboard.linrco_representative') }}" required/>
                                        </div>

                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.linrco_cr') }} :</label>
                                            <input value="{{ old('linrco_cr') }}" name="linrco_cr" type="text" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            ...
                                            <input value="{{ old('linrco_mail_box') }} " name="linrco_mail_box" type="text" class="form-control"
                                                   placeholder="{{ trans('dashboard.linrco_mail_box') }}" />
                                        </div>
                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.company_representative') }} :</label>
                                            <input value="{{ $company->company_representative }}" name="company_representative" type="text"
                                                   class="form-control" placeholder="{{ trans('dashboard.company_representative') }}" required/>
                                        </div>
                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.company_cr') }} :</label>
                                            <input value="{{ $company->cr }}" name="company_cr" type="text"
