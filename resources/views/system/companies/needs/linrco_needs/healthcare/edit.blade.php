                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input value="{{$need->educational_qualification }}" name="educational_qualification" type="text"
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <select id="data_flow" class="form-control select2" name="data_flow"
                                                    required>
                                                <option value="" selected="">{{ trans('dashboard.Select All') }}</option>
                                                <option {{ $need->data_flow == 3 ? 'selected' : '' }} value="3">{{ trans('dashboard.Not required') }}</option>
                                                <option {{ $need->data_flow == 1 ? 'selected' : '' }} value="1" >{{ trans('dashboard.Required from inside the Kingdom') }}</option>
                                                <option {{ $need->data_flow == 2 ? 'selected' : '' }} value="2">{{ trans('dashboard.Required from outside the Kingdom') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            ...
                                            <select id="prometric" class="form-control select2" name="prometric"
                                                    required>
                                                <option value="" selected="">{{ trans('dashboard.Select All') }}</option>
                                                <option {{ $need->prometric == 1 ? 'selected' : '' }} value="1">{{ trans('dashboard.yes') }}</option>
                                                <option {{ $need->prometric == 2 ? 'selected' : '' }} value="2" >{{ trans('dashboard.No') }}</option>
                                            </select>
                                        </div>
                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.classification') }}:</label>
                                            <input value="{{$need->classification }}" name="classification" type="text"
                                                   class="form-control"
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input value="{{$need->total_experience }}" name="total_experience" type="text"
                                                   class="form-control"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            ...
                                            <input value="{{$need->area_of_experience }}" name="area_of_experience" type="text"
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input value="{{$need->total_salary }}" name="total_salary" type="text" class="form-control"
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input value="{{$need->other_skills }}" name="other_skills" type="text" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            ...
                                            <input value="{{$need->special_note }}" name="special_note" type="text"
