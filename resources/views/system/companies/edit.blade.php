                            ...
                            <form method="post" action="{{ route('companies.update' , $company->id) }}" class="form" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            ...
                                            <input value="{{ $company->translate('ar')->name }}" name="name_ar" type="text" class="form-control" placeholder="{{ trans('dashboard.Company Name Arabic') }}" required/>
                                            @error('name_ar')
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input value="{{ $company->translate('en')->name }}" name="name_en" type="text" class="form-control" placeholder="{{ trans('dashboard.Company Name English') }} " required/>
                                            @error('name_en')
                                            <div class="error">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.phone number') }} :{{ $company->phone }}</label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input value="{{ $company->district }}" name="district" type="text" class="form-control" placeholder="{{ trans('dashboard.District') }}"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.Location') }}:</label>
                                            <input value="{{ $company->location }}" name="location" type="text" class="form-control" placeholder="{{ trans('dashboard.Location') }}"/>
                                        </div>
                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.Branches Number') }}:</label>
                                            <input value="{{ $company->branch_number }}" name="branch_number" type="text" class="form-control" placeholder="{{ trans('dashboard.Branches Number') }}"/>
                                        </div>
                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.Number of Employees Company') }}:</label>
                                            <input value="{{ $company->num_of_employees }}" name="num_of_employees" type="text" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            ...
                                            <input value="{{ $company->ecn  }}" name="ecn" type="text" class="form-control" placeholder="{{ trans('dashboard.ECN') }}"/>
                                        </div>
                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.CR') }}:</label>
                                            <input value="{{ $company->cr }}" name="cr" type="text" class="form-control" placeholder="{{ trans('dashboard.CR') }}"/>
                                        </div>
                                        <div class="col-lg-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input value="{{ $company->linkedin }}" name="linkedin" type="text" class="form-control" placeholder="{{ trans('dashboard.Linkedin') }}"/>
                                        </div>
                                        <div class="col-lg-3">
                                            <label>{{ trans('dashboard.Twitter') }}:</label>
                                            <input value="{{ $company->twitter }}" name="twitter" type="text" class="form-control" placeholder="{{ trans('dashboard.Twitter') }}"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label>{{ trans('dashboard.Name') }}:</label>
                                            <input value="{{ $company->company_representative_name }}" name="company_representative_name" type="text" class="form-control" placeholder="{{ trans('dashboard.Name') }}"/>
                                        </div>
                                        <div class="col-lg-6">
                                            <label>{{ trans('dashboard.Job Title') }}:</label>
                                            <input value="{{ $company->company_representative_job_title }}" name="company_representative_job_title" type="text" class="form-control" placeholder="{{ trans('dashboard.Job Title') }}"/>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.Mobile') }}:</label>
                                            <input class="form-control tel leyka_donor_phone" type="tel" name="company_representative_job_mobile" inputmode="tel" value="{{ $company->company_representative_job_mobile }}" />
                                            <input value="{{ $company->company_representative_job_mobile }}" name="company_representative_job_mobile" type="hidden" class="form-control company_representative_job_mobile"
                                                   placeholder="{{ trans('dashboard.Mobile') }}"/>

                                        </div>
                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.Email') }}:</label>
                                            <input value="{{ $company->company_representative_job_email }}" name="company_representative_job_email" type="email" class="form-control" placeholder="{{ trans('dashboard.Email') }}"/>

                                        </div>
                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.Phone') }}:</label>
                                            <div class="input-group">
                                                <input class="form-control tel leyka_donor_phone" type="tel" name="company_representative_job_phone" inputmode="tel" value="{{ $company->company_representative_job_phone }}" />
                                                <input value="{{ $company->company_representative_job_phone }}" name="company_representative_job_phone" type="hidden" class="form-control company_representative_job_phone" placeholder="{{ trans('dashboard.Phone') }}" aria-describedby="basic-addon2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label>{{ trans('dashboard.Name') }}:</label>
                                            <input value="{{ $company->hr_director_job_name }}" name="hr_director_job_name" type="text" class="form-control" placeholder="{{ trans('dashboard.Name') }}"/>
                                        </div>
                                        <div class="col-lg-6">
                                            <label>{{ trans('dashboard.Email') }}:</label>
                                            <input value="{{ $company->hr_director_job_email }}" name="hr_director_job_email" type="text" class="form-control" placeholder="Mobile"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <input value="{{ $company->hr_director_mobile }}" name="hr_director_mobile" type="hidden" class="form-control hr_director_mobile"
                                                   placeholder="{{ trans('dashboard.Mobile') }}"/>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <input value="{{ $company->hr_director_whatsapp }}" name="hr_director_whatsapp" type="hidden" class="form-control hr_director_whatsapp" placeholder="{{ trans('dashboard.HR Whatsapp') }}"/>

                                        </div>
                                        <div class="col-lg-6">
                                            <label>{{ trans('dashboard.HR Linkedin') }}:</label>
                                            <input value="{{ $company->hr_director_linkedin }}" name="hr_director_linkedin" type="text" class="form-control hr_director_linkedin" placeholder="{{ trans('dashboard.HR Linkedin') }}"/>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label>{{ trans('dashboard.Mobile') }}:</label>
                                            <input class="form-control tel leyka_donor_phone" type="tel" name="contract_manager_mobile" inputmode="tel" value="{{ $company->contract_manager_mobile }}" />
                                            <input value="{{ $company->contract_manager_mobile }}" name="contract_manager_mobile" type="hidden" class="form-control contract_manager_mobile"
                                                   placeholder="{{ trans('dashboard.Mobile') }}"/>

                                        </div>
                                        <div class="col-lg-6">
                                            <label>{{ trans('dashboard.Phone') }}:</label>
                                            <input class="form-control tel leyka_donor_phone" type="tel" name="contract_manager_phone" inputmode="tel" value="{{ $company->contract_manager_phone }}" />

                                            <input value="{{ $company->contract_manager_phone }}" name="contract_manager_phone" type="hidden" class="form-control contract_manager_phone" placeholder="{{ trans('dashboard.Phone') }}"/>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label>{{ trans('dashboard.HR Whatsapp') }}:</label>
                                            <input class="form-control tel leyka_donor_phone" type="tel" name="contract_manager_whatsapp" inputmode="tel" value="{{ $company->contract_manager_whatsapp }}" />
                                            <input value="{{ $company->contract_manager_whatsapp }}" name="contract_manager_whatsapp" type="hidden" class="form-control contract_manager_whatsapp" placeholder="{{ trans('dashboard.HR Whatsapp') }}"/>

                                        </div>
                                        <div class="col-lg-6">
                                            <label>{{ trans('dashboard.Linkedin') }}:</label>
                                            <input value="{{ $company->contract_manager_linkedin }}" name="contract_manager_linkedin" type="text" class="form-control contract_manager_linkedin" placeholder="{{ trans('dashboard.Linkedin') }}"/>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        @if($company->evaluation_status)
                                            ...
                                            <div class="col-lg-6">
                                                <label>{{ trans('dashboard.By User') }} :</label>
                                                <input class="form-control" type="text" value="{{ $company->evaluator ? app()->getLocale() == 'ar' ? $company->evaluator->name : $company->evaluator->name_en : '-'}}" readonly>
                                            </div>
                                        @else
                                            <div class="col-lg-12">
                                                <label>{{ trans('dashboard.Company Evaluation') }} :</label>
                                    ...
                                    <div class="form-group row">
                                        @if($company->client_status)
                                            ...
                                            <div class="col-lg-6">
                                                <label>{{ trans('dashboard.By User') }} :</label>
                                                <input class="form-control" type="text" value="{{ $company->client_status_user ? app()->getLocale() == 'ar' ? $company->client_status_user->name : $company->client_status_user->name_en : '-'}}" readonly>
                                            </div>
                                        @else
                                            <div class="col-lg-12">
                                                <label>{{ trans('dashboard.Client Status') }} :</label>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            ...
                                            <textarea name="notes" class="form-control"   rows="5">{{ $company->notes }}</textarea>
                                        </div>
                                    </div>
