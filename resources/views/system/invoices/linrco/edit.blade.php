                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <h2 class="text-white font-weight-bold my-2 mr-5">
                            {{ trans('dashboard.Edit Invoice For ') }} {{ $linrco_invoice->company->name }}
                        </h2>
                        <!--end::Title-->
                        ...
                        <div class="d-flex align-items-center font-weight-bold my-2">
                            ...
                            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                            <a href="{{ route('CompanyAgreement.index' , [$linrco_invoice->company->id , $mother_company_id]) }}" class="text-white text-hover-white opacity-75 hover-opacity-100">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom">
                            <form method="post" action="{{ route('companyInvoice.update' , $linrco_invoice->id) }}" class="form"
                                  enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                <input value="{{ $linrco_invoice->linrco_agreement_id }}" name="linrco_agreement_id" type="hidden" />
                                <input value="{{ $linrco_invoice->company->id }}" name="company_id" type="hidden" />
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            ...
                                            <div class="input-group input-group-solid date"
                                                ...
                                                <input value="{{ $linrco_invoice->date }}" name="date" type="date"
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input value="{{ $linrco_invoice->company->client_code  }}" name="client_code" type="text"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                            ...
                                            <input value="{{ $linrco_invoice->internal_contact }}" name="internal_contact" type="text" class="form-control"
                                                   placeholder="{{ trans('dashboard.internal_contact') }}" />
                                        </div>
                                        <div class="col-lg-3">
                                            <label>{{ trans('dashboard.telephone') }} :</label>
                                            <input value="{{ $linrco_invoice->telephone }} " name="telephone" type="text" class="form-control"
                                                   placeholder="{{ trans('dashboard.telephone') }}" />
                                        </div>
                                        <div class="col-lg-3">
                                            <label>{{ trans('dashboard.email') }}:</label>
                                            <input value="{{ $linrco_invoice->email }}" name="email" type="text"
                                                   class="form-control" placeholder="{{ trans('dashboard.email') }}" required/>
                                        </div>

                                        <div class="col-lg-3">
                                            <label>{{ trans('dashboard.customer_vat_no') }}:</label>
                                            <input value="{{ $linrco_invoice->company->customer_vat_no }}" name="customer_vat_no" type="text"
                                            ...
                                            <div data-repeater-list="" class="col-lg-12">
                                                @foreach($linrco_invoice->LinrcoInvoiceRequest as $request)
                                                    ...
                                                    <div class="col-lg-3 mb-2">
                                                        ...
                                                        <input arr-name="item" value="{{ $request->particulars }}"  name="particulars" type="text" class="form-control" placeholder="{{ trans('dashboard.Emp.Name') }}"/>
                                                    </div>
                                                    <div class="col-lg-3 mb-2">
                                                        <label>{{ trans('dashboard.recruitment_fee') }}:</label>
                                                        <input arr-name="item" value="{{ $request->recruitment_fee }}" name="recruitment_fee" type="text" class="form-control adminFees" placeholder="recruitment_fee"/>
                                                    </div>
                                                    <div class="col-lg-3 mb-2">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12 text-center">
                                            ...
                                            <a href="{{ route('companyInvoice.index' , [$linrco_invoice->linrco_agreement_id , $mother_company_id]) }}"
