                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom">
                            ...
                            <form method="post" action="{{ route('sectors.store') }}" class="form">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <input value="{{ old('name_ar') }}" name="name_ar" type="text" class="form-control" placeholder="{{ trans('dashboard.Sector Name Arabic') }}"/>
                                            @error('name_ar')
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input value="{{ old('name_en') }}" name="name_en" type="text" class="form-control" placeholder="{{ trans('dashboard.Sector Name English') }}"/>
                                            @error('name_en')
                                            <div class="error">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <a href="{{ route('sectors.index') }}" class="btn btn-secondary">{{ trans('dashboard.cancel') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
