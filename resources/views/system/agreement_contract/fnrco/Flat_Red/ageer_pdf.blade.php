...
<head>
    ...
    <title>Visa Agreement Ageer </title>
...
<main>
    ...
    <table style="line-height: 22px">
        ...
        <tr>
            <td style="width: 50%; text-align: right;  font-size: 12px; vertical-align: top">
                الشركة الوطنية الأولى للموارد البشرية شركة سعودية مساهمه مقفلة سجل تجاري رقم ١٠١٠٣٥٥٠٢٦و يمثلها في
                التوقيع على هذا العقد السيد / عايض تركي علي بصفته نائب المدير العام المدير العام، العنوان المملكة
                العربية السعودية مدينة الرياض ، حي الملز،١١٣٤٢ ص.ب ٢٦١٦٥٦<br>
            ...
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">
                1. The first national Company, a Saudi Closed Joint Stock Company, Commercial Registration #:
                1010355026, and represented in signing hereon by Mr Ayed Turki Ali in his capacity as Deputy General
                Manager.<br>
        ...
        <tr>
            <td style="width: 50%; text-align: right;  font-size: 12px; vertical-align: top">
                {{ $fnrco_flat_red_agreement->company->name }} شركة عاملة مسجلة تحت نظام وزارة التجارة و الإستثمار في المملكة العربية السعودية بموجب السجل التجاري رقم
                {{ $fnrco_flat_red_agreement->company->cr }}  تاريخ  {{ $fnrco_flat_red_agreement->cr_date }}ونظام وزارة الموارد البشرية و التنمية الاجتماعية بالرقم  {{ $fnrco_flat_red_agreement->hr_system }}.و يمثلها بالتوقيع
                ...
                العنوان البريدي : {{ $fnrco_flat_red_agreement->mailing_address }}<br>
                الرمز البريدي : {{ $fnrco_flat_red_agreement->postal_code }}<br>
                عنوان البريد الإلكتروني : {{ $fnrco_flat_red_agreement->company->email }}<br>
                )ويشار إليها في هذا العقد بالطرف الثاني (

            </td>
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">
                2.{{ $fnrco_flat_red_agreement->company->name }} It is a company operating and registered under the system of the Ministry of Commerce and
                Investment in the Kingdom of Saudi Arabia under the commercial registration No {{ $fnrco_flat_red_agreement->company->cr }} Date/ {{ $fnrco_flat_red_agreement->cr_date }} and the
                law of the Ministry of Human Resources and Social Development under No/ {{ $fnrco_flat_red_agreement->hr_system }} and represented in
                signing hereon by Mr./ {{ $fnrco_flat_red_agreement->signing_by }} in his capacity as {{ $fnrco_flat_red_agreement->by_as }}<br/>
                Address: {{ $fnrco_flat_red_agreement->address_en }}<br/>
                Phone: {{ $fnrco_flat_red_agreement->phone }}<br/>
                Fax: {{ $fnrco_flat_red_agreement->fax }}<br/>
                Postal code: {{ $fnrco_flat_red_agreement->postal_code }} , P.O. BOX {{ $fnrco_flat_red_agreement->mailing_address }}<br/>
                E-mail address: {{ $fnrco_flat_red_agreement->company->email }}<br/>
        ...
        <tr>
            ...
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">
                Whereas the Second party is willing to recruit candidates from the countries allowing such recruitment
                following the regulations of Saudi Arabia, due to the company’s need for technical and professional
                candidates. <br>
                And since the Second party has a license for recruiting candidates from abroad and has the
                professional experience in respect to this field, as well as he is ready and agrees to perform this job,
                then he is selected to be one of the authorized representatives of the Second party to recruit the
                candidates required. The two parties competently agreed on the following:
    ...
    <table>
        ...
        <tr>
            <td style="width: 50%; text-align: right;  font-size: 12px; vertical-align: top">
                يعتبر التمهيد المتقدم جزءًا لا يتجزأ من هذا العقد يقرأ ويفسر معه.<br>
        ...
        <tr>
            <td style="width: 50%; text-align: right;  font-size: 12px; vertical-align: top">
                <strong style="text-decoration: underline"> اﻟﺘﺰاﻣﺎت اﻟﻄﺮف اﻷول:</strong>
                <br/>
                ...
                3. فتح الحسابات البنكية للموظفين لدفع رواتبهم.


            </td>
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">
                <strong style="text-decoration: underline"> OBLIGATIONS OF FIRST PARTY:</strong>
        ...
        <tr>
            <td style="width: 50%; text-align: right;  font-size: 12px; vertical-align: top">
                <strong style="text-decoration: underline"> اﻟﺗزاﻣﺎت اﻟطرف اﻟﺛﺎﻧﻲ:</strong>
            ...
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">
                <strong style="text-decoration: underline"> OBLIGATIONS OF SECOND PARTY:</strong>
                ...
                either party based on rates mentioned in Annexure (1).
                <br/>
                ...
                for Chamber of Commerce attestation to the First Party when signing this contract.
        ...
        <tr>
            <td style="width: 50%; text-align: right;  font-size: 12px; vertical-align: top">
                ...
                4. الحفاظ على نسبة التوطين حسب متطلبات وزارة الموارد البشريه والتنمية الاجتماعية وجميع أنظمة واشتراطات
                الوزارة وبرنامج (أجير)، وﻓﻲ ﺣﺎل عدم تصحيح وﺿﻌﮫ ﺧﻼل ﻣﺪة أﻗﺼﺎھﺎ (15) يوم ﻣﻦ ﺗﺎرﯾﺦ اﻹﺷﻌﺎر ﻓﺈﻧﮫ ﯾﺘﺤﻤﻞ غرامة
                شهرية قدرها ٨٠٠ ريال سعودي عن كل كادر لا يستطيع الطرف الثاني تسجيله في نظام (أجير) ومبلغ هذه الغرامة
                متفق عليه بالتراضي بين الطرفين ولايحق لأي منهما الاعتراض عليه فيما بعد . كما يحق للطرف الأول على إثر ذلك
                سحب العمالة وتحميل الطرف الثاني كافة الأتعاب المستحقة عليه عن الفترة السابقة بالإضافة إلى رسوم الإقامات
                ورخص العمل وأي رسوم حكومية أخرى مستحقة عن كامل فترة العقد، بالإضافة إلى (50%) خمسون بالمائة من الأتعاب
                الشهرية عن باقي فترة العقد. وهذا متفق عليه بالتراضي بين الطرفين ولايحق لأي منهما الاعتراض عليه فيما بعد
                <br/>
                5. لا يحق للطرف الثاني مطالبة الطرف الأول باستبدال أي من الكوادر العاملين لديه طوال فترة التعاقد لأي سبب
                كان.
                <br/>
                6. يلتزم الطرف الثاني بتقديم الطعام المجاني للعمالة أو بدل طعام، بالإضافة إلى توفير مستلزمات ومعدات
                إعداد الطعام للموظفين.

            </td>
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">

                4. The SECOND PARTY shall maintain the percentage of Saudization according to the requirements of the
                Ministry of Human Resources & Social Development and all the Ministry’s regulations and requirements and
                Ajeer program. If the condition is not corrected within a period of (15) days from the date of
                notification, Second Party bears monthly fine of 800 Saudi Riyals for each candidate that Second party
                cannot register in Ajeer system. The amount of this fine is agreed between the two parties, and neither
                of them has the right to object on it later.
                <br/>
                5. The Second Party has no right to ask the FIRST PARTY for replacing the employees for any reason.
                <br/>
                6. The Second Party shall provide either free food or food allowance with necessary kitchen utensils and
                cooking facilities.
        ...
        <tr>
            <td style="width: 50%; text-align: right;  font-size: 12px; vertical-align: top">
                ...
                7. يلتزم الطرف الثاني بتوفير خدمات النقل للعمالة المطلوبة واللائقة خلال فترة الاتفاقية، وتأمين معدات
                السلامة والوقاية الشخصية والتدريب لهم علي الاعمال المطلوبة منهم بالاضافة الي توفير أي معدات أو آليات قد
                تكون مطلوبة لتنفيذ الأعمال وإصدار الشهادات وبوالص التأمين اللازمة كتأمين المركبات وغيرها، كما يلتزم
                بتأمين السكن الملائم لهم أيضا كلاً حسب وظيفته وحسب المتفق عليه مع العامل عند إستقدامه .

            </td>
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">

                7. SECOND PARTY shall provide transportation for the hired workers, safety and personal protection and
        ...
        <tr>
            <td style="width: 50%; text-align: right;  font-size: 12px; vertical-align: top">
                <strong style="text-decoration: underline"> الرسـوم :</strong> <br/>
                1. يلتزم الطرف الثاني بدفع مستحقات الطرف الأول وذلك في مواعيد استحقاقها.
                <br/>
            ...
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">
                <strong style="text-decoration: underline">Fees:</strong><br/>
                1. Second Party must pay the dues of the First Party on their due dates.
                ...
                appropriate without referring to the Second party, including the following:
                <br/>
                a) Terminate the contract and withdraw all workers immediately.
                <br/>
        ...
        <tr>
            <td style="width: 50%; text-align: right;  font-size: 12px; vertical-align: top">
                <strong style="text-decoration: underline"> أحكام وشروط :</strong> <br/>
            ...
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">
                ...
                with the quota set by the Saudi Ministry of Human Resources & Social Development.
                <br/>
                ...
                fines, the Second party shall bear them alone.

                <br/>
                - Mobilization period shall be maximum 90 days from the date of submission of E-wakala.
                <br/>
                ...
                Development regulations. Any changes in the employee's working hours to less than ({{ $fnrco_flat_red_agreement->work_hours_weekly }}) hours
                per week will be applied according to the laws in the Kingdom of Saudi Arabia, without affecting the
                First Party's charges.
                <br/>
                ...
                of Human Resources & Social Development regulations.
    ...
    <table>
        ...
        <tr>
            <td style="width: 50%; text-align: right;  font-size: 12px; vertical-align: top">
                - مدة هذا العقد (عامان) من تاريخ التوقيع عليه و يجدد تلقائياً ما لم يخطر أحد الطرفين الأخر برغبته في عدم
                التجديد قبل إنتهاء العقد بشهرين على الأقل. <br>
                - تسري اﻻﺗﻔﺎﻗﯿﺔ اﻟﺨﺎﺻﺔ ﺑﻜﻞ ﻣﻮظﻒ ﻟﻤﺪة 24 ﺷﮭﺮ ﻣﯿﻼدي ﻣﻦ ﺗﺎرﯾﺦ وﺻﻮله إﻟﻰ اﻟﻤﻤﻠﻜﺔ اﻟﻌﺮﺑﯿﺔ اﻟﺴﻌﻮدﯾﺔ ﺑﻐﺾ اﻟﻨﻈﺮ
                ﻋﻦ ﻓﺘﺮة ﺳﺮﯾﺎن اﻻﺗﻔﺎﻗﯿﺔ وﺳﺘﻜﻮن ﻣﻠﺰﻣﺔ ﻟﻄﺮﻓﻲ ھﺬه اﻻﺗﻔﺎﻗﯿﺔ. <br>
                - ﻻ ﯾﺟوز ﻟﻠطرف اﻟﺛﺎﻧﻲ اﻟﺗﻌﺎﻗد ﻣﻊ اﻟﻣوظف ﻣﺑﺎﺷرة ﻗﺑل ﻣﺿﻲ ﻋﺎﻣﯾن ﻣن ﺗﺎرﯾﺦ اﻧﺗﮭﺎء ﺧدﻣﺔ اﻟﻌﺎﻣل ﻟدى اﻟطرف اﻷول
                إﻻ ﺑﻣواﻓﻘﺗﮫ، وﻓﻲ ﺣﺎل ﻣﺧﺎﻟﻔﺔ اﻟﻌﻣﯾل ﻟذﻟك ﯾﻛون ﻣﻠزﻣﺎً ﺑدﻓﻊ ﺗﻌوﯾض ﯾﻌﺎدل 15% ﻣن اﻟراﺗب اﻟﺳﻧوي اﻟذي ﻛﺎن
                ﯾﺗﻘﺎﺿﺎه اﻟﻌﺎﻣل.


            </td>
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">
                - The contract duration is (2 years) from the date of signature and shall be automatically renewed
                unless one of the parties notifies the other of its desire not to renew at least 2 months before the end
                of the agreement.<br>
                - The agreement for each employee shall be effective for a period of 24 Gregorian months from the date
                of arrival of the employee to Saudi Arabia. This shall be binding for both parties even though if this
                agreement expired.<br>
                - The SECOND PARTY shall not directly hire the employee of the FIRST PARTY before completing of 2 years
                from the end of his agreement with the FIRST PARTY’s consent. In the case of violating this article, the
                SECOND PARTY will be obliged to pay compensation equivalent to 15% of the annual salary the employee was
                receiving.
    ...
    <table>
        ...
        <tr>
            <td style="width: 50%; text-align: right;  font-size: 12px; vertical-align: top">
                ...
                إلى 50% من الأتعاب الشهرية لباقي فترة الاتفاقية.<br>
        ...
        <tr>
            ...
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">
                ...
                received one original copy to act accordingly. In case of discrepancy the Arabic text shall
                prevail.<br/>
    ...
    <table style="line-height: 26px">
        ...
        <tr>
            <td style="width: 50%; text-align: center;  font-size: 12px; vertical-align: top ; direction: rtl">
                ...
                التاريخ :  {{ $fnrco_flat_red_agreement->date }}
...
<main>
    ...
    <table class="ltr">
        ...
        <tr>
            <td rowspan="6" style="font-size: 12px;">7</td>
            <td rowspan="6" style="font-size: 12px;text-align: left">Bank Details for Transactions</td>
