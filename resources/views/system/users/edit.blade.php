                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input value="{{ $user->name_en }}" name="name_en" type="text"
                                                   class="form-control"
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            ...
                                            <select class="form-control select2" name="parent_id">
                                                ...
                                                @foreach($data['managers'] as $manager)
                                                    <option {{ $manager->id == $user->parent_id ? 'selected' : '' }} value="{{ $manager->id }}">{{ app()->getLocale() == 'ar' ? $manager->name : $manager->name_en }}</option>
                                                @endforeach
                                            </select>
                                            @error('parent_id')
                                            <div class="error">{{ $message }}</div>
