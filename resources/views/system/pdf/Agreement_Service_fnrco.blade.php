    ...
    <table style="line-height: 22px">
        ...
        <tr>
            ...
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">
                ...
                a total value of (------- SR) as an insurance to be recovered after the end of this contract The second
            ...
            <td style="width: 50%; text-align: right;  font-size: 12px; vertical-align: top">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;  font-size: 12px; line-height: 18px" colspan="4"></td>
                        <td style="text-align: center;  font-size: 12px; line-height: 18px"></td>
                    </tr>
                    <tr>
                        <td style="text-align: center;  font-size: 12px; line-height: 18px"></td>
        ...
        <tr>
            ...
            <td class="en ltr" style="width: 50%; text-align: left; font-size: 12px; vertical-align: top">
                ...
                The term of this Agreement shall be (------) from the date of signature and shall be automatically
