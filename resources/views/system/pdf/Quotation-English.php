...
<div class="page1">
    ...
    <main>
        ...
        <table class="en ltr" style="line-height: 24px; border: none;">
            ...
            <tbody>
            <tr class="en ltr">
                <td class="en ltr" style="background: #999;font-size: 12px; vertical-align: middle; text-align: center">TRADE</td>
                <td class="en ltr" style="background: #999;font-size: 12px; vertical-align: middle; text-align: center">GENDER</td>
                <td class="en ltr" style="background: #999;font-size: 12px; vertical-align: middle; text-align: center">QUALIFICATION</td>
                <td class="en ltr" style="background: #999;font-size: 12px; vertical-align: middle; text-align: center">QTY</td>
                <td class="en ltr" style="background: #999;font-size: 12px; vertical-align: middle; text-align: center">NATIONALITY</td>
                <td class="en ltr" style="background: #999;font-size: 12px; vertical-align: middle; text-align: center">SALARY (SAR)</td>
                <td class="en ltr" style="background: #999;font-size: 12px; vertical-align: middle; text-align: center">RECRUITMENT CHARGES PER CANDIDATE</td>
                <td class="en ltr" style="background: #999;font-size: 12px; vertical-align: middle; text-align: center">VISA PROCESSING CHARGES PER CANDIDATE(U.S $)</td>
            </tr>
            <tr>
                ...
                <td class="en ltr" style="font-size: 12px; vertical-align: middle;">3500+300+ Transport & Accommodation</td>
        ...
        <p class="en ltr" style="line-height: 24px;">
            ...
            •	Dataflow, Pro-Metric & Classification charges will be reimbursed by the client before candidate’s arrival at Actuals<br/>
