...
@if (app()->getLocale() == 'ar')
    ...
    <head>
        ...
        <title> {{$fnrco_flat_red_quotation->company->name }} عرض اسعار الى </title>
        @else

            <html lang="en" dir="ltr">
            <head>
                <meta http-equiv="Content-Type" content="text/html;charset=UTF-8">
                <title>Quotation For {{$fnrco_flat_red_quotation->company->name }} </title>
        ...
        @endif
                <tbody>
                    <tr>
                        ...
                        <td class="en ltr"
                            style="font-size: 12px; vertical-align: middle;">{{ $fnrco_flat_red_quotation->company->name }}
                        </td>
                        <td class="en ltr"
                        ...
                        <td class="en ltr" style="font-size: 12px; vertical-align: middle;">
                            {{ $fnrco_flat_red_quotation->ref_no }}
                        </td>
                    </tr>
                    <tr>
                        <td class="en ltr"
                        ...
                        <td class="en ltr"
                            style="font-size: 12px; vertical-align: middle;">{{ $fnrco_flat_red_quotation->attn }}

                        </td>
                        <td class="en ltr"
                            style="font-size: 12px; vertical-align: middle; background-color: #d7d7d7;">{{ __('dashboard.Date') }} </td>
                        <td class="en ltr" style="font-size: 12px; vertical-align: middle;">
                            {{ $fnrco_flat_red_quotation->created_at }}
                        </td>
                    </tr>
                    <tr>
                        <td class="en ltr"
                    ...
                    <tr>
                        ...
                        <td class="en ltr" style="font-size: 12px; vertical-align: middle;">
                            {{ $fnrco_flat_red_quotation->email }}
                        </td>
                        <td class="en ltr"
            ...
            @endif
                ...
                <table class="en ltr" style="line-height: 16px; border: none;">
                    ...
                    @foreach($fnrco_flat_red_quotation->fnrcoFlatredQuotationRequests as $fnrco_request)
                        <tr>
                            <td class="en ltr"
                ...
                <p class="en ltr" style="line-height: 18px;">
                        ...
                        أخرى ، ودفع الإجازة ،
                        @if($fnrco_flat_red_quotation->saudization == 0)
                            <strong>السعودة </strong>,
                        @endif
                        ، والتأمين ، وتذاكر الطيران ، والرسوم الحكومية الأخرى.<br/>
                        3. توفر شركة
                        {{ $fnrco_flat_red_quotation->company->name }}
                        ،
                        @if($fnrco_flat_red_quotation->saudization == 1)
                            <strong>و السعودة </strong>
                        @endif

                        ، إقامة الموظفين ونقلهم. <br/>
                        4. مدة عقد القوى العاملة
                        @if($fnrco_flat_red_quotation->Contract_period == 12)
                            <strong>12 شهر</strong>
                        @elseif($fnrco_flat_red_quotation->Contract_period == 24)
                            <strong>24 شهر</strong>
                        @endif
                        قابلة للتجديد حسب معايير الشروط والأحكام الموضوعة.<br/>
                    ...
                    @else
                        ...
                        @endif
                        will be
                        provided by {{ $fnrco_flat_red_quotation->company->name }} .<br/>
