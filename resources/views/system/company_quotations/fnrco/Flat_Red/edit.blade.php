            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="{{ route('companyQuotation.index' , [$fnrco_flat_red_quotation->company_id , $mother_company_id]) }}" class="text-white text-hover-white opacity-75 hover-opacity-100">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-custom">
                        <form method="post" action="{{ route('update_visa_flatred_quotation' , $fnrco_flat_red_quotation->id) }}" class="form"
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input value="{{ $fnrco_flat_red_quotation->ref_no }}" name="ref_no" type="text" class="form-control"
                                               placeholder="{{ trans('dashboard.Ref: No') }}" required/>
                                    </div>
                                    <div class="col-lg-4">
                                        <label>{{ trans('dashboard.Attn') }} :</label>
                                        <input value="{{ $fnrco_flat_red_quotation->attn }}" name="attn" type="text" class="form-control"
                                               placeholder="{{ trans('dashboard.Attn') }}" required/>
                                    </div>
                                    <div class="col-lg-4">
                                        <label>{{ trans('dashboard.Tel') }} :</label>
                                        <input value="{{ $fnrco_flat_red_quotation->telephone }}" name="telephone" type="text" class="form-control"
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-3">
                                        ...
                                        <input value="{{ $fnrco_flat_red_quotation->mobile }} " name="mobile" type="text" class="form-control"
                                               placeholder="{{ trans('dashboard.Mobile') }}" />
                                    </div>
                                    <div class="col-lg-3">
                                        <label>{{ trans('dashboard.E-mail') }} :</label>
                                        <input value="{{ $fnrco_flat_red_quotation->email }}" name="email" type="text"
                                               class="form-control" placeholder="{{ trans('dashboard.E-mail') }}" required/>
                                    </div>
                                    <div class="col-lg-3">
                                        <label>{{ trans('dashboard.Quotation No') }} :</label>
                                        <input value="{{ $fnrco_flat_red_quotation->Quotation_No }}" name="Quotation_No" type="text"
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <select class="form-control select2" id="period" name="Contract_period"
                                            ...
                                            <option {{ $fnrco_flat_red_quotation->Contract_period == 12 ? 'selected' : ''}} value="12"  iqama="1115.5" >12 {{ trans('dashboard.Month') }}</option>
                                            <option {{ $fnrco_flat_red_quotation->Contract_period == 24 ? 'selected' : ''}} value="24" iqama="1019.6">24 {{ trans('dashboard.Month') }}</option>
                                        </select>
                                ...
                                <div id="kt_repeater_1">
                                    <div id="kt_repeater_1" class="form-group row">
                                        <div data-repeater-list="" class="col-lg-12">
                                            @foreach($fnrco_flat_red_quotation->fnrcoFlatredQuotationRequests as $request)
                                                ...
                                                <input arr-name="item" type="hidden" name="request_id" value={{ $request->id }}>
                                                    ...
                                                    <div class="col-lg-3 mb-2">
                                                        ...
                                                        <input arr-name="item" value="{{ $request->visa_category_available }}" name="visa_category_available" type="text"
                                                    ...
                                                    <div class="col-lg-3 mb-2">
                                                        ...
                                                        <input arr-name="item" value="{{ $request->visa_category_arabic }}" name="visa_category_arabic" type="text"
                                ...
                                {{--<div class="form-group row">--}}
                                    {{--<div class="col-lg-12">--}}
                                        ...
                                        {{--<input {{ $fnrco_flat_red_quotation->saudization == 1 ? 'checked' : ''}} value="1" name="saudization" type="checkbox"/>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                                        <button type="submit"
                                                ...
                                                <a href="{{ route('companyQuotation.index' , [$fnrco_flat_red_quotation->company_id , $mother_company_id]) }}"
