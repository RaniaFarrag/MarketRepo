                                ...
                                @foreach($linrco_quotation->linrcoQuotationsRequest as $linrco_request)
                                    <tr>
                                        <td class="en ltr"
                                            ...
                                            {{ $linrco_request->trade }}
                                        </td>
                                        <td class="en ltr"
                                            style="font-size: 12px; vertical-align: middle;text-align: center;">
                                            @if($linrco_request->gender == 1)
                                                Male
                                            @elseif($linrco_request->gender == 2)
                                                Female
                                            @endif
                                        </td>
                                        <td class="en ltr"
                                            style="font-size: 12px; vertical-align: middle;text-align: center;">
                                            {{ $linrco_request->educational_qualification }}
                                        </td>
                                        <td class="en ltr"
                                            style="font-size: 12px; vertical-align: middle;text-align: center;">
                                            {{ $linrco_request->quantity }}
                                        </td>
                                        <td class="en ltr"
                                            style="font-size: 12px; vertical-align: middle;text-align: center;">
                                        ...
                                        <td class="en ltr"
                                            style="font-size: 12px; vertical-align: middle;text-align: center;">
                                            {{ $linrco_request->RECRUITMENT_CHARGES_PER_CANDIDATE }}
                                        </td>
                                        <td class="en ltr"
                                            style="font-size: 12px; vertical-align: middle;text-align: center;">
                                            {{ $linrco_request->VISA_PROCESSING_CHARGES_PER_CANDIDATE }}
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
