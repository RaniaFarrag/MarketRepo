                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom">
                            ...
                            <form method="post" action="{{ route('motherCompany.update' , $motherCompany->id) }}" class="form" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <input value="{{ $motherCompany->name  }}" name="name" type="text" class="form-control" placeholder="{{ trans('dashboard.Mother Company Name Arabic') }}" required/>
                                            @error('name')
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input value="{{ $motherCompany->name_en }}" name="name_en" type="text" class="form-control" placeholder="{{ trans('dashboard.Mother Company Name English') }}" required/>
                                            @error('name_en')
                                            <div class="error">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            <label>{{ trans('dashboard.logo') }} :</label>
